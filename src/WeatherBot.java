...
public class WeatherBot {
	...
	//getTemp Method runs if "city" is recognized
	public static String getTemp(String Name) throws IOException {
		//Web address for API
		//https://api.openweathermap.org/data/2.5/weather?q={Name}&appid={Key}&units=imperial
		
		//Constructing the custom web address using the API key and the users inputed city
		String myAPIurl = "https://api.openweathermap.org/data/2.5/weather?q="; 
		String myAPItoken = "&appid=a79b93d2956bc7ddb29f49280c2655cb";
		String weatherURL = myAPIurl + Name + myAPItoken + "&units=imperial";
		String result = "";
